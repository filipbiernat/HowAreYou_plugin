...
public class PluginActions {
    ...
    public static final String ACTION_START_QUESTION_EMOJI = "ACTION_START_QUESTION_EMOJI";
    public static final String ACTION_ON_FINISHED_QUESTION_EMOJI= "ACTION_ON_FINISHED_QUESTION_EMOJI";
    public static final String ACTION_START_PHOTO_EMOTION_RECOGNITION = "ACTION_START_PHOTO_EMOTION_RECOGNITION";
